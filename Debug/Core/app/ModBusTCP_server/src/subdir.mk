...
C_SRCS += \
../Core/app/ModBusTCP_server/src/mb_tcp_app.c 

C_DEPS += \
./Core/app/ModBusTCP_server/src/mb_tcp_app.d 

OBJS += \
./Core/app/ModBusTCP_server/src/mb_tcp_app.o 


# Each subdirectory must supply rules for building sources it contributes
Core/app/ModBusTCP_server/src/%.o Core/app/ModBusTCP_server/src/%.su Core/app/ModBusTCP_server/src/%.cyclo: ../Core/app/ModBusTCP_server/src/%.c Core/app/ModBusTCP_server/src/subdir.mk
...
clean: clean-Core-2f-app-2f-ModBusTCP_server-2f-src

clean-Core-2f-app-2f-ModBusTCP_server-2f-src:
	-$(RM) ./Core/app/ModBusTCP_server/src/mb_tcp_app.cyclo ./Core/app/ModBusTCP_server/src/mb_tcp_app.d ./Core/app/ModBusTCP_server/src/mb_tcp_app.o ./Core/app/ModBusTCP_server/src/mb_tcp_app.su

.PHONY: clean-Core-2f-app-2f-ModBusTCP_server-2f-src
