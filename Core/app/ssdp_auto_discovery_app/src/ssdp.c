...
static const char device_description [] =
    ...
    "</specVersion>"
    "<device>"
    "<deviceType>urn:schemas-upnp-org:device:CedarSwitch:1</deviceType>"
...
static const char ssdp_notify_template[] =
    ...
    "NT: urn:schemas-upnp-org:device:CedarSwitch:1\r\n"
    "NTS: ssdp:alive\r\n"
    "SERVER: STM32/Mongoose UPnP/1.1 CedarSwitch/1.0\r\n"
    "USN: uuid:%s::urn:schemas-upnp-org:device:CedarSwitch:1\r\n"
    "\r\n";
