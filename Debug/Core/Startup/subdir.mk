...
Core/Startup/%.o: ../Core/Startup/%.s Core/Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I../Core/app/mqtt_client_app/inc -I../Core/app/http_server_app/inc -I../Drivers/i2c_display/inc -I../Middlewares/Third_Party/crypto_lib_mbed_TLS/include/mbedtls -I../Middlewares/Third_Party/crypto_lib_mbed_TLS/library -I../Middlewares/Third_Party/crypto_lib_mbed_TLS/include/psa -I../Middlewares/Third_Party/crypto_lib_mbed_TLS/include -I../Core/app/sntp_app/inc -I../Core/app/ModBusTCP_server/inc -I../Core/app/ModBusTCP_server/freemodbus_1.6/modbus/include -I../Core/app/ModBusTCP_server/freemodbus_1.6/modbus/port -I../Core/app/ModBusTCP_server/freemodbus_1.6/modbus/tcp -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=standard_c_nano_cpp.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
